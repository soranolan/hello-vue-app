...
export default {
  name: 'F03001JS',
  methods: { validFindAllByUserId, findAllByUserId, buildQueryString, validfindOneByDocumentId, findOneByDocumentId, dateFormat, setDisable, getApiMenuData, handleCurrentChange }
};
